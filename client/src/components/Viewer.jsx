...
const Viewer = () => {
  ...
  useEffect(() => {
    WebViewer(
      ...
      instance.UI.disableElements(["freeTextToolGroupButton", "Free Text"]);
      instance.UI.disableElements(["crossStampToolButton", "Cross"]);
      instance.UI.disableElements(["dotStampToolButton", "Dot"]);
      instance.UI.disableElements(["dateFreeTextToolButton", "Calendar"]);
      ...
      instance.UI.setHeaderItems((header) => {
        header.push({
          ...
          onClick: async () => {
            ...
            formData.append("filename", "1.pdf");
