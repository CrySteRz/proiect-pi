                ...
                <div className="jb-apply-form bg-white shadow rounded py-3 px-4 box-static">
                  ...
                  <form className="_apply_form_form">
                    <div className="form-group">
                      <label className="text-dark mb-1 ft-medium medium">Upload Resume:<small className="medium ft-medium">pdf, doc, docx</small></label>
                    ...
                    <div className="form-group">
                      <div className="terms_con">
                        ...
                        <label htmlFor="aa3" className="checkbox-custom-label">I agree to privacy policy</label>
                      </div>
                    </div>
                    <div className="form-group">
                      {/*To be modified back to button*/}
                      <Link to="/" className="btn btn-md rounded theme-bg text-light ft-medium fs-sm full-width">Apply For This Job</Link>
                    </div>
                  </form>
                </div>
              </div>
